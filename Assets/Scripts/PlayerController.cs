...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (!UIController.instance.startPanel.activeSelf && Input.GetMouseButtonDown(0)) // Solo clic si está inactivo el panel start
        {
            // Obtener la posición actual del jugador
            Vector3 playerPosition = player.position;

            // Instanciar el nuevo GameObject en la misma posición en el eje Z que el jugador
